...
<div class="page-wrapper">
    <div class="page-content">
        <div class="header-section d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('operator.ekskul.create') }}" class="btn btn-light btn-sm">
        ...
        <div class="content-section">
            <div class="search-section">
                <form method="GET" action="{{ route('operator.ekskul') }}" class="d-flex">
                    <input type="text" name="search" class="form-control" placeholder="Cari nama ekskul atau pembina..." value="{{ request('search') }}">
                ...
                <table class="table table-striped table-hover align-middle">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>Nama Ekskul</th>
                            <th>Pembina</th>
                            <th class="d-none d-md-table-cell">Jadwal_latihan</th>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <form action="{{ route('operator.ekskul.destroy', Crypt::encrypt($item->id_ekskul)) }}" method="post"
                                              onsubmit="return confirm('Yakin ingin menghapus data ekskul ini?')" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
